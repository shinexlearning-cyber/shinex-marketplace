...
router.get('/stats', async (req, res) => {
  try {
    ...
    // Count by status
    // NOTE: supabase-js's query builder has no .group() method (that is
    // a PostgREST/SQL concept, not part of this client's API) — calling
    // it throws a TypeError and crashed this endpoint entirely. Instead,
    // fetch the status column for every payment and aggregate in JS.
