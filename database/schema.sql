...
CREATE INDEX idx_payments_paystack_reference ON advertisement_payments(paystack_reference);
CREATE INDEX idx_payments_status ON advertisement_payments(status);
